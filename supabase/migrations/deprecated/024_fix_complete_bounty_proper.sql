-- ============================================================================
-- Migration 024: Proper Fix for complete_bounty_with_winners Return Type
-- Created: 2025-10-10
-- Purpose: Fix SQLSTATE 42804 by using RETURN QUERY instead of RETURN NEXT
-- ============================================================================
...
BEGIN
    ...
    -- Return the winners using RETURN QUERY (not RETURN NEXT)
    RETURN QUERY
    SELECT
        bp.user_id AS winner_user_id,
        bp.prize_amount_won AS prize_awarded,
...
'Determines winners automatically based on bounty criteria, marks them, and returns winner details. Uses RETURN QUERY for proper type matching (migration 024).';
...
-- MIGRATION COMPLETE
-- ============================================================================
-- Fix: Changed from RETURN NEXT to RETURN QUERY
-- This properly matches the return type structure
-- ============================================================================
